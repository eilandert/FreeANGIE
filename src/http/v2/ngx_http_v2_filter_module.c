...
ngx_http_v2_header_filter(ngx_http_request_t *r)
{
    ...
    static size_t nginx_name_len = ngx_http_v2_literal_size(ANGIE_NAME);
    static u_char nginx_name[ngx_http_v2_literal_size(ANGIE_NAME)];

    static size_t nginx_ver_len = ngx_http_v2_literal_size(ANGIE_VER);
    static u_char nginx_ver[ngx_http_v2_literal_size(ANGIE_VER)];

    static size_t nginx_ver_build_len =
                                  ngx_http_v2_literal_size(ANGIE_VER_BUILD);
    static u_char nginx_ver_build[ngx_http_v2_literal_size(ANGIE_VER_BUILD)];
